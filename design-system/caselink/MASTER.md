...
> **STATUS: REJECTED BASELINE — DO NOT IMPLEMENT.** This file is the unedited
> output of the UI/UX Pro Max search run requested on 2026-08-03. Its
> claymorphism, family-blue/chore-green palette, rounded surfaces, and
> futuristic type conflict with the CaseLink brief. Use
> `ART-DIRECTIONS.md` for the active design exploration until one direction is
> selected and promoted into the durable project design system.
